...
const items = document.getElementById("list-of-posts");
...
const nav = document.getElementsByTagName("nav")[0]; // 1
const sideBar = document.getElementById("sidebar-left"); // 2
const pages = document.getElementsByClassName("pages")[0]; // 3
const groups = document.getElementsByClassName("groups")[0]; // 3
sideBar.getElementsByClassName("favorites")[0].getElementsByTagName("h5")[0].textContent =
  "Least Favs"; // 4
const ads = document.getElementsByClassName("ads")[0]; // 5
ads.firstElementChild.style.visibility = "hidden"; // 5
ads.firstElementChild.style.visibility = "visible"; // 6
ads.firstElementChild
  .getElementsByTagName("img")[0]
  .setAttribute("src", "http://placebear.com/200/300"); // 7
const listOfPosts = document.getElementById("list-of-posts"); // 8
listOfPosts.getElementsByTagName("p")[4].innerText = "something incredible"; // 8
listOfPosts.getElementsByTagName("li")[0].classList.add("post-liked"); // 9
const secondPost = listOfPosts.getElementsByTagName("li")[7];
secondPost.classList.add("post-shared"); // 10
secondPost.classList.remove("post-shared"); // 11
